...
import type { RequestConfig, ApiResponse, BriqConfig } from '../types/common';
import {
    NetworkError,
    TimeoutError,
    AuthenticationError,
...
import { isRetryableError, calculateBackoffDelay, delay } from '../utils/helpers';
...
export class HttpClient extends BaseClient {
    ...
    protected async executeRequest(config: RequestConfig): Promise<Response> {
        ...
        try {
            ...
            const networkError = new NetworkError('Network request failed', { originalError: error.message });
            throw networkError;
        }
    }
    ...
    protected handleError(error: any): Error {
        ...
        return new NetworkError('Unexpected error occurred', { originalError: error });
    }
