...
import type { ApiResponse, BaseEntity, BriqConfig, PaginatedResponse } from './types/common';
...
export const SDK_INFO = {
    name: 'briq-sdk',
    version: VERSION,
    description: 'Official TypeScript/JavaScript SDK for Karibu Briq SMS API',
    ...
    license: 'MIT',
    repository: 'https://github.com/briq-sdk/sdk-typescript',
    briq_documentation: 'https://briq.tz/documentation/home',
    documentation: 'https://docs.karibu.briq.tz/sdk/typescript',
    apiVersion: 'v1'
} as const;